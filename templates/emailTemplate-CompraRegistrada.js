module.exports = function generarEmail(nombre, ticket, texto) {
    return `
    <!DOCTYPE html>
    <html>
      <head>
                ...
                <tr>
                  <td style="padding-left: 40px;padding-right: 40px;">
                    ...
                    <p style="font-size:16px; color:#004d40;">
                     Hemos registrado una nueva compra exitosamente:
                    </p>
                    <p style="font-weight: bold; color:#004d40;">
                      No de nota registrado es: ${ticket}
                    </p>
                          <p style="font-size:16px; color:#004d40;">
                     ${texto}, entra a <a href="https://maxaniversario.com" style="color:#004d40; font-weight: bold;">MaxAniversario.com</a> inicia sesión y ve a "Mis Trivias" para participar.
                    </p>
                    <p style="font-size:16px; color:#004d40;">
